...
const Profile = () => {
  return (
    <section id="profile" className="bg-[#F2F1E8] flex flex-col items-center">
      <div className="relative w-full aspect-[390/614] lg:aspect-[1514/1100] overflow-hidden">
        <img
        ...
        {/* GRADIENT BAWAH */}
        <div className="absolute bottom-0 left-0 w-full h-[76.92vw] lg:h-[400px] bg-gradient-to-t from-[#F2F1E8] to-transparent" />
      ...
      <div className="mt-[14.36vw] mb-[27.69vw] lg:mt-[40px] lg:mb-[216px]">
        <p className="text-[4.10vw] lg:text-[28px] font-helvetica font-medium tracking-[0.03vw] leading-[5.13vw] lg:tracking-[0px] lg:leading-[30px] text-[#191A2A] text-justify w-[50.51vw] lg:w-[368px]">
