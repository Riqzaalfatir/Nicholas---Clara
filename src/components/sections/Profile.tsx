  ...
  return (
    <section id="profile" className="bg-[#F2F1E8] flex flex-col items-center">
     ...
     <div className="mt-[103px] mb-[108px] lg:mt-[40px] lg:mb-[216px]">
        <p className="text-[4.10vw] lg:text-[28px] font-helvetica font-medium leading-[22px] lg:tracking-[0px] lg:leading-[30px] text-[#191A2A] text-justify w-[50.51vw] lg:w-[368px]">
