...
const Hero = ({ start }: { start: boolean }) => {
  return (
    <section id="hero" className="bg-[#F2F1E8] flex items-center justify-center leading-none">
      <div className="relative pt-[46.41vw] pb-[46.92vw] lg:pt-[113px] lg:pb-[83px] flex flex-col w-[85.38vw] lg:w-[526px]">
        {/* Foto */}
        <div className="absolute w-[61.54vw] h-[92.31vw] top-[51.28vw] lg:w-[370px] lg:h-[556px] lg:top-[141px] left-1/2 -translate-x-1/2 -ml-[0.72vw] lg:-ml-[0.2vw] z-0">
          <img
        ...
        <div className="flex flex-col">
          ...
          <h1 className="text-[12.31vw] lg:text-[76px] font-montreal font-regular mt-[1.28vw] lg:mt-[6px] whitespace-nowrap -ml-[0.51vw] lg:-ml-[0vw] z-10 relative [mix-blend-mode:exclusion] text-[#F2F1E8]">
            Nicholas & Clara
          </h1>
          ...
          <p className="text-[3.08vw] lg:text-[18px] font-helvetica font-bold text-[#191A2A] mt-[11.54vw] lg:mt-[79px] self-end">
            Ecclesiastes 4:9-10
          </p>
