...
const Thankyou = () => {
  return (
    <section className="bg-[#F2F1E8]">
      <div className="pt-[36.41vw] pb-[4.62vw]">
        <div className="relative flex flex-col items-center justify-center">
          {/* Foto */}
          <div className="absolute w-[61.54vw] h-[92.31vw] top-[12.82vw] left-1/2 -translate-x-1/2 z-0">
            <img
          ...
          <h1 className="font-montreal font-regular text-[16.41vw] z-10 relative [mix-blend-mode:exclusion] text-[#F2F1E8]">
            Thank You
          </h1>
          <p className="font-helvetica font-medium text-[3.08vw] text-[#191A2A] pt-[85.90vw] -ml-[1.28vw]">
          ...
          <Image
            ...
            width={89}
            height={65}
            className="object-contain mt-[37.18vw] w-[22.82vw] h-[16.67vw]"
          />
        </div>
      </div>
    </section>
