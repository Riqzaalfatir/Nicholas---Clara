        ...
        <div className="pt-[120px] pb-[120px] lg:pt-[236px] lg:pb-[247px] px-[0.5vw]">
          <div className="flex flex-col items-center justify-center leading-none">
            ...
            <motion.p
              ...
              viewport={{ once: true, amount: 0.3 }}
              transition={{ duration: 3, ease: "easeOut" }}
              className="font-montreal font-regular text-[3.08vw] lg:text-[18px] text-[#191A2A] mt-[26px] lg:mt-[48px]"
            >
              Sela
            </motion.p>
            <motion.p
              ...
              viewport={{ once: true, amount: 0.3 }}
              transition={{ duration: 3, ease: "easeOut" }}
              className="font-montreal font-regular text-[3.08vw] lg:text-[18px] text-[#191A2A] text-center mt-[24px] lg:mt-[48px] tracking-wide leading-[5.13vw] lg:leading-[25px]"
            >
            ...
            <motion.p
              ...
              viewport={{ once: true, amount: 0.3 }}
              transition={{ duration: 3, ease: "easeOut" }}
              className="font-montreal font-regular text-[3.08vw] lg:text-[18px] text-[#191A2A] mt-[37px] lg:mt-[43px]"
            >
              {pilihan === "tidak_hadir"
                ? "ARE YOU SURE?"
            ...
            <motion.p
              ...
              viewport={{ once: true, amount: 0.3 }}
              transition={{ duration: 3, ease: "easeOut" }}
              className="font-montreal font-regular text-[2.56vw] lg:text-[18px] text-[#191A2A] mt-[54px] lg:mt-[81px] text-center tracking-wide leading-[4.36vw] lg:leading-[25px]"
            >
